...
\hspace{1em} Всё хорошее когда-нибудь заканчивается и настаёт пора суровой реальной жизни. Так и для нас наступило время переходить к трёхмерному пространству. Давайте попробуем разобраться, как изменится подход к описанию систем такого типа.
...
\end{align*}
Можно заметить, что $r\sin^2\theta \cos\phi \sin\phi \frac{\partial}{\partial r} - r\sin^2\theta\cos\phi\sin\phi\frac{\partial}{\partial r} = 0$. Второй член аналогично сократится. Тогда можно записать, что
\begin{align*}
...
\begin{gather*}
\hat{\Vec{r}}\hat{\Vec{p}} = -i\hbar r\frac{\partial}{\partial r};\\
